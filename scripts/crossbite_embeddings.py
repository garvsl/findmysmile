...
#load the data
crossbite = SimpleDirectoryReader(input_dir="../data/crossbite").load_data() #read the content within the crossbite directory

 # only read one file for one procedure
print(crossbite)  # print out the data to see what it looks like raw
...
response = query_engine.query("Provide me details pertaining to the crossbite dental procedure based on the data you have been provided.")
print("\n\n")  #create some spacings
print("Query Response For Crossbite:")
...
txt_file_path = os.path.join(output_dir, "crossbite_query_response.txt")
